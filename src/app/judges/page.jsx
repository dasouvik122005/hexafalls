...
export const metadata = {
  ...
  description:
    "Judges and mentors join the council of HexaFalls, a 58-hour wizarding hackathon at JIS University. Applications open soon. Co-developed by Ayushman Bhattacharya.",
};
