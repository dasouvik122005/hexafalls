...
// Judges form link can be dropped in here later; kept "coming soon" for now.
const JUDGES_FORM_URL = null;
...
const SCROLLS = [
  ...
  },
  {
    ...
    blurb: "Wise hands, sharp eyes — guide the council and crown the victors.",
    color: "#66FCF1",
